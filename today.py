...
USER_NAME = os.environ['USER_NAME'] # 'SoubhagyaGhoshal'
...
if __name__ == '__main__':
    """
    Soubhagya Ghoshal (SoubhagyaGhoshal), 2022-2025
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': '...'} and ... for username 'SoubhagyaGhoshal'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2002, 5, 30))
    ...
    # Removed Andrew's specific archive data calculation
